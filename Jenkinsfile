pipeline {
    ...
    environment {
        KOYEB_EMAIL = credentials('HERALDS_OF_CHAOS_KOYEB_EMAIL')
        KOYEB_PASSWORD = credentials('HERALDS_OF_CHAOS_KOYEB_PASSWORD')
        KOYEB_SERVICE_ID = credentials('HERALDS_OF_CHAOS_KOYEB_SERVICE_ID')
    }
